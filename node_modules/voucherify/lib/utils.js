...
module.exports = {
  ...
  webhooks: {
    verifySignature: function verifySignature(signature, message, secretKey) {
      return crypto.createHmac('sha256', secretKey).update(isString(message) && message || (0, _stringify2.default)(message)).digest('hex') === signature;
    }
  }
};